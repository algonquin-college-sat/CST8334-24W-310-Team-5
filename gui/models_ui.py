...
class Ui_ModelsWindow(object):
    def setupUi(self, ModelsWindow):
        ...
        # Add the QLabel for "Model Type:"
        self.label_ModelType = QtWidgets.QLabel(self.centralwidget)
        self.label_ModelType.setGeometry(QtCore.QRect(340, 62, 100, 30))
        self.label_ModelType.setObjectName("label_ModelType")
        self.label_ModelType.setText("Model Type:")

        # Add the QComboBox
        self.comboBox_ModelType = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_ModelType.setGeometry(QtCore.QRect(420, 62, 200, 30))
        self.comboBox_ModelType.setObjectName("comboBox_ModelType")
        self.comboBox_ModelType.addItem("Logistic Regression")
