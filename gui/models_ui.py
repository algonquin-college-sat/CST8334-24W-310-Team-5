...
class Ui_ModelsWindow(object):
    def setupUi(self, ModelsWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 70, 651, 161))
        ...
        self.comboBox_ModelType.addItem("Random Forest")
        self.comboBox_ModelType.addItem("XGBoost")
        self.comboBox_ModelType.addItem("MLP Classifier")
        self.comboBox_ModelType.addItem("AdaBoost")

        # HLayout for Model Type
        self.modelTypeHLayout = QtWidgets.QHBoxLayout()
        self.modelTypeHLayout.setObjectName("modelTypeHLayout")
        self.modelTypeHLayout.setContentsMargins(10, 10, 10, 10)
        self.modelTypeHLayout.addWidget(self.label_ModelType)
        self.modelTypeHLayout.addWidget(self.comboBox_ModelType)
        self.grp_hlayout1.addLayout(self.modelTypeHLayout)

        # Properties Button
        self.btn_ModelProperties = QtWidgets.QPushButton(self.groupBox)
        self.btn_ModelProperties.setFont(font)
        self.btn_ModelProperties.setObjectName("btn_ModelProperties")

        # HLayout for Properties Button
        self.propertiesHLayout = QtWidgets.QHBoxLayout()
        self.propertiesHLayout.setObjectName("propertiesHLayout")
        self.propertiesHLayout.setContentsMargins(10, 0, 10, 10)
        self.propertiesHLayout.addWidget(self.btn_ModelProperties)
        self.grp_hlayout1.addLayout(self.propertiesHLayout)
        ...
        self.sBox_Epochs.setGeometry(QtCore.QRect(151, 61, 111, 31))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(290, 30, 631, 71))
        self.groupBox_4.setObjectName("groupBox_4")
        self.group_vlayout4.addWidget(self.groupBox_4)

        # Using QVBoxLayout for vertical alignment of checkboxes
        self.group_hlayout4 = QtWidgets.QVBoxLayout()
        ...
        self.cBox_MetricsAccuracy.setGeometry(QtCore.QRect(70, 50, 71, 10))
        ...
        self.cBox_MetricsPrecision.setChecked(True)
        self.cBox_MetricsPrecision.setGeometry(QtCore.QRect(160, 50, 71, 10))
        ...
        self.cBox_MetricsRecall.setChecked(True)
        self.cBox_MetricsRecall.setGeometry(QtCore.QRect(250, 50, 71, 10))
        ...
        # F1 Score Checkbox
        self.cBox_MetricsF1 = QtWidgets.QCheckBox(self.groupBox_4)
        self.cBox_MetricsF1.setChecked(True)
        self.cBox_MetricsF1.setGeometry(QtCore.QRect(250, 50, 71, 10))
        self.cBox_MetricsF1.setObjectName("cBox_MetricsF1")
        self.cBox_MetricsF1.setToolTip("Measures the model's ability to detect positive samples.")
        self.cBox_MetricsF1.setToolTipDuration(6000)
        self.group_hlayout4.addWidget(self.cBox_MetricsF1)
    ...
    def retranslateUi(self, ModelsWindow):
        ...
        self.btn_ModelProperties.setText(_translate("ModelsWindow", "Properties"))
        ...
        self.cBox_MetricsF1.setText(_translate("ModelsWindow", "F1 Score"))
